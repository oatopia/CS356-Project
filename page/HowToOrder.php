    ...
    <section class="HowToOrder-content">
        ...
        <div class="Step-HowToOrder">
            ...
            <div >
                ...
                <p>เมื่อท่านค้นพบสินค้าที่ต้องการแล้ว เพียงแค่ท่านเลือกสี,ไซส์ และจำนวนแล้วคลิกที่ เพิ่มไปยังรถเข็น ท่านก็สามารถเลือกรายการสินค้าที่ต้องการลงในรถเข็นของท่านได้</p>
            </div>
            <div>
                <label><img src="../image/icon/list.png"/>จัดการรายการสินค้าที่สั่งซื้อในรถเข็น</label>
                <p>ในหน้ารายการสินค้าที่สั่งซื้อของท่าน จะแสดงรายการ, จำนวน และรายละเอียดของสินค้าที่ท่านเลือก พร้อมทั้งราคารวมของสินค้าทั้งหมดที่อยู่ในรถเข็น ท่านสามารถแก้ไขรายการสินค้าในรถเข็นนี้ได้เมื่อคลิกที่ปุ่ม ลบสินค้า หากท่านต้องการสั่งซื้อสินค้าให้กดปุ่ม สั่งซื้อสินค้า</p>
            </div>
            <div>
                <label><img src="../image/icon/Group.png"/>กำหนดที่อยู่สำหรับจัดส่งสินค้า</label>
                <p>ท่านต้องกรอกที่อยู่ที่จัดส่งในหน้าที่อยู่ซึ่ง ท่านสามารถไปโดยชี้ที่ชื่อผู้ใช้ของท่านแล้วเลือกเมนูที่อยู่ เมื่อท่านเคยกรอกที่อยู่แล้วระบบจะแสดงบนหน้าจอ ท่านสามารถแก้ไข้ที่อยู่ของท่านได้โดยการกดปุ่ม แก้ไขที่อยู่ หากท่านต้องการบันทึกที่อยู่ใหม่ที่พึ่งแก้ไขให้กดปุ่ม บันทึกที่อยู่ </p>
            </div>
            <div>
                <label><img src="../image/icon/credit.png"/>แจ้งการชำระเงิน</label>
                <p>หากท่านชำระเงินเรียบร้อยแล้ว ท่านสามารถแจ้งการชำระเงินได้ที่หน้าแจ้งการชำระเงิน ท่านสามารถไปโดยชี้ที่เมนูการสั่งซื้อสินค้าแล้วเลือกแจ้งโอนเงิน ให้ท่านกรอกข้อมูลให้ครบทุกช่องเมื่อกรอกครบแล้วให้ท่านกดปุ่ม แจ้งการชำระเงินเป็นอันเรียบร้อย</p>
            </div>
        </div>
