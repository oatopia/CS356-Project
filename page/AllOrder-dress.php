<?php
   ...
   //select all product
   $sql = "SELECT * FROM collection_product WHERE Collection_type='Dress'";
...
<head>
    ...
    <link rel="stylesheet" href="./css/AllOrder-dress-php.css?v=<?php echo time(); ?>">
    </header>
...
<body>
    ...
    <section class="left-content">
        ...
        <ul>
            ...
            <li><a  href="./AllOrder-dress.php" id="link-dress">เดรส</a></li>
        </ul>
    </section>
